...
extern OCConnectionEndpointID OCConnectionEndpointIDWebDAVTrashBin; //!< Trash bin API endpoint
extern OCConnectionEndpointID OCConnectionEndpointIDWebDAVTrashBinRoot; //!< Virtual endpoint, builds trash bin root URL for the logged-in user
extern OCConnectionEndpointID OCConnectionEndpointIDTrashPreview; //!< Classic ownCloud trash preview endpoint (apps/files_trashbin/ajax/preview.php)
